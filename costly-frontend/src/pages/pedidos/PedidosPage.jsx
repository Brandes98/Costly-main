...
export default function PedidosPage() {
  ...
  <label className="btn btn-outline text-xs cursor-pointer">
    ...
    <input type="file" className="hidden" accept=".xlsx,.xls"
      ...
      {modalImp && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-ink/40 px-4">
<div className="w-full max-w-lg rounded-card border border-border bg-sur shadow-xl min-h-[200px]">            <div className="flex items-center justify-between border-b border-border px-5 py-4">
              <div>
...
<div className="px-5 py-4 space-y-3 min-h-[150px]">              <div className="space-y-1.5">
